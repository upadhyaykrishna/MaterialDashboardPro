    ...
    <div>
      ...
      <div className="absolute left-[19rem] max-w-full top-32 xl:left-5 ">
        <div className="flex flex-row mb-5 xl:w-full lg:flex-wrap">
            {/* Box1 */}
            <div className="w-80 h-72 bg-white rounded-xl mr-5 lg:mb-5">
        ...
        <div className="mb-6 flex-row flex">
          <div className="bg-white w-64 h-44 rounded-xl mr-6">
            <div className="flex flex-row justify-between">
          ...
          <div className="bg-white w-36 h-44 mr-6 rounded-xl">
            <div className="mt-6">
          ...
          <div className="bg-white w-60 h-40 rounded-xl pt-3 mr-6 lg:flex-wrap">
          ...
          <div className="bg-white w-36 h-40 rounded-xl mr-6">
          ...
          <div className="bg-white w-36 h-40 rounded-xl pt-5">
        ...
        {/* 4th row */}
        <div className="mb-6 flex flow-row">
          <div className="bg-white w-[27rem] h-[33rem] pt-4 rounded-xl mr-6">
            <p className="text-black1 font-bold ml-4">Calendar</p>
            <p className="text-heading ml-4">Monday, 2021</p>
          </div>

          <div>
            <div className="bg-white w-60 h-[22rem] rounded-xl pt-4 mr-6 mb-5">
              <p className="text-black1 font-bold ml-4 mb-5">Categories</p>
              <Categories />
            </div>

            <div className="bg-dark w-60 h-40 rounded-xl text-white">
