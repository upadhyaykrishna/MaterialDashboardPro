...
const Battery = (props) => {
  return (
    <>
         <div className='max-w-lg lg:w-96 mr-6 w-64 md:flex-grow md:w-screen md:mr-5'>
            <div className="bg-white w-full h-24 rounded-xl flex items-center justify-between mb-6  md:flex-grow md:w-screen">
