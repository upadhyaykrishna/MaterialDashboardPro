  ...
  return (
    <>
      {listOfCategory.map((element) => {
        return (
          <div className="grid grid-cols-4 mt-4 items-center lg:grid-cols-12">
            <div className="m-4">
              <div className="bg-dark w-7 h-7 rounded-lg flex items-center justify-center">
                {element.icon}
              </div>
            </div>
            <div className="col-span-2 lg:col-span-10">
              <p className="text-sm text-black1 font-bold">
                {element.categoryName}
              </p>
              <p className="text-xs text-heading">
                {element.text1}
                <span className="font-semibold"> {element.text2} </span>{" "}
              </p>
            </div>
            <div className="">
              <ChevronRightIcon />
